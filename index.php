...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>P</span>izzaShop</a>
 ...
 <section>
    ...
    <div class="box" style="padding: 20px;">
      <div class="card1">
       ...
       <div class="card1">
         <div class="imgBx">
            <img src="images/o2.png" alt="images">
         </div>
         <div class="details">
       ...
       <div class="card1">
         <div class="imgBx">
            <img src="images/o3.png" alt="images">
         </div>
         <div class="details">
  ...
  <div class="box" style="padding: 20px;">
    <div class="card1">
      <div class="imgBx">
          <img src="images/o4.png" alt="images">
      </div>
      <div class="details">
          <h2>SomeOne Famous<br><span>Director</span></h2>
      </div>
     ...
     <div class="card1">
       <div class="imgBx">
          <img src="images/o5.png" alt="images">
       </div>
       <div class="details">
          <h2>SomeOne Famous<br><span>Producer</span></h2>
        </div>
     ...
     <div class="card1">
       <div class="imgBx">
          <img src="images/o6.png" alt="images">
       </div>
       <div class="details">
          <h2>SomeOne Famous<br><span>Actor</span></h2>
        </div>
...
<section id="menu" class="menu">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <img src="<?= $fetch_products['image'] ?>" alt="nh">
         ...
         <form action="" method="post">
            ...
            <input type="submit" class="btn" name="add_to_cart" id="add_cart" value="add to cart">
         </form>
      </div>
      <?php
         }
...
<section class="review" >
   <h1 class="heading">Shop Review</h1>
<div class="pizzavideo">
      <video width="100%" height="700" style="padding: 20px;" controls>
        <source src="images/pizza1.mp4" type="video/mp4">
      </video>
...
<section class="about" id="about">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <h3>Our Pizza, Your Happiness</h3>
         <p>At pizzashop, our mission is simple: to turn every pizza into a moment of joy. We believe that a delicious pizza can bring a smile to your face and create memories with loved ones. With a commitment to taste, quality, and your satisfaction, we're here to serve up happiness one slice at a time. Join us in the pursuit of pizza perfection!</p>
         <a href="#menu" class="btn">our menu</a>
      </div>

      <div class="box">
         <img src="images/about-2.svg" alt="">
         <h3>A Slice of Italy, Right at Home</h3>
         <p>Transport your taste buds to the heart of Italy without leaving your neighborhood. pizzashop is where authentic Italian pizza traditions meet the comfort of home. Our wood-fired ovens, imported ingredients, and skilled pizzaiolos ensure that every bite takes you on a culinary journey to Italy.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>

      <div class="box">
         <img src="images/about-3.svg" alt="">
         <h3>Family Tradition and Quality</h3>
         <p>PizzaShop is more than just a pizzeria; it's a family tradition rooted in quality and flavor. Our story began generations ago, and our commitment to using time-honored recipes and fresh, locally sourced ingredients hasn't wavered. We invite you to savor the taste of tradition with every slice and join our pizza-loving family.</p>
         <a href="#menu" class="btn">our menu</a>
      </div>
...
<section class="faq" id="faq">
   ...
   <div class="accordion-container">
      ...
      <div class="accordion">
         <div class="accordion-heading">
            <span>How long do you take to deliver?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
      ...
      <div class="accordion">
         <div class="accordion-heading">
            <span>Can I order from any location?</span>
            <i class="fas fa-angle-down"></i>
         </div>
         <p class="accrodion-content">
